                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none ">
                        <div className="relative w-auto mx-auto my-6">
                            ...
                            <div className="relative flex flex-col bg-white border-0 rounded-lg shadow-lg outline-none w-96 focus:outline-none">
                                ...
                                {/*body*/}
                                <div className="relative items-stretch flex-auto w-full p-6 mx-auto my-4 mb-3">
                                    <div>
                                        ...
                                        <input
                                            className="relative w-full px-1 py-2 pl-10 text-lg text-gray-500 placeholder-gray-400 bg-gray-100 rounded shadow outline-none focus:bg-white focus:outline-none focus:shadow-lg"
                                            type="text"
                                            ref={taskTitle}
                                ...
                                <div className="flex items-center justify-end p-6 border-t border-gray-300 border-solid rounded-b">
                                    <button
                                        className="px-6 py-2 mb-1 mr-1 text-sm font-bold uppercase outline-none text-carnationRed background-transparent focus:outline-none"
                                        type="button"
                                    ...
                                    <button
                                        className={`px-6 py-3 mb-1 mr-1 text-sm font-bold text-white uppercase rounded shadow outline-none bg-cornFlowerBlue active:bg-green-600 hover:shadow-lg focus:outline-none ${
